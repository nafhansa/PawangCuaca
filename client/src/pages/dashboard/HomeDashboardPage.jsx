  ...
  return (
    <div className="home-dashboard-page">
      <div className="page-header">
        <h1 className="page-title">🌦️ Cuaca Hari Ini</h1>
        <p className="page-subtitle">Pantau kondisi cuaca real-time untuk lokasimu</p>
      </div>
        ...
        <>
          ...
          {currentHour && (
            <VotingPanel
              ...
              lat={lat}
              lon={lon}
              locationLabel={activeCoords?.label || `${lat?.toFixed(2)}, ${lon?.toFixed(2)}`}
            />
          )}
          {lat && lon && (
